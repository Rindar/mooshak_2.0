...
intellisense.annotate(jQuery.fn, {
  ...
  'id': function() {
    /// <signature>
    ///   <summary>Selects a single element with the given CourseId attribute.</summary>
    ///   <param name="CourseId" type="String">An ID to search for, specified via the CourseId attribute of an element.</param>
    /// </signature>
  },
  'image': function() {
